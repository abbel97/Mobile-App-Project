              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text('My Requests', style: AppTextStyles.headline2.copyWith(
                    ...
                    if (state.isLoading && state.requests.isEmpty)
                      ...
                      ...state.requests.map((r) => _RequestCard(
                            ...
                            dateLabel: 'Submitted ${r.createdAt.substring(0, 10)}',
                            showEdit: r.isPending,
                            onEdit: r.isPending ? () => context.push(
                                    AppRoutes.customerRequestEditPath(r.id)) : null,
                            onDelete: () => showDialog(
                              context: context,
              ...
              Expanded(
                child: Text(title,
                    style: AppTextStyles.titleSmall.copyWith(
                        fontSize: 18, color: AppColors.primary, height: 1.2)),
              ),
              Container(
